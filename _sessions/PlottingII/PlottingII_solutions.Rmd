---
title: "Plotting II Practical Solutions"
subtitle: ""
...
1. Open your `RBootcamp` R project. It should already have the folders `1_Data` and `2_Code`. Make sure that the data files listed in the `Datasets` section above are in your `1_Data` folder. Also check for the folder `3_Figures`.
...
### D - Customize plots using your own `theme()`
...
### H - Visualise something you find interesting

This task is a little different from the ones above, because you do not have a dataset available (yet) and no clear goal what your graphic should look like.

1. Think about things that you find interesting, that 'get you going', that make your blood boil, that you spend time on. This could be things like Twitter, music, politics, the weather, the swiss school system, climate change, scouts, ... there is really no limit - come up with 2-3 topics.

2. Evaluate the topics you generated in step 1 on 2 dimensions: a) Is it possible to as a question about this topic that I can visualise with ggplot2? and b) Is there data available online or private that I can use?

3. Given that you could answer both questions in 2) go on and (down)load a fitting dataset, wrangle it and visualise it. Ideally you will put the question you generated on the graph as a (sub)title.

4. Contingency plan: if you struggle (a lot) with 1:3 drop me a note and I will give you a dataset + question. 
...
|File | Rows | Columns | 
|:----|:-----|:------|
|[crime.csv](https://michaelschulte.github.io/RBootcamp/1_Data/crime.csv) | 1071 | 36 | 
